...
**NOTE:** Support for `pnpm` is available for all versions.
...
```
pack build <app-name> -p <path-to-app> -b <path/to/node-engine.cnb> -b <path/to/pnpm.cnb> /
...
For most apps, the Pnpm Install Buildpack runs fine on the [Base
